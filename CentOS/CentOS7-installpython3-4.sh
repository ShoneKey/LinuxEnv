...
curl -O -sSL https://npm.taobao.org/mirrors/python/3.6.9/Python-3.6.9.tar.xz && xz -d Python-3.6.9.tar.xz && tar xvf Python-3.6.9.tar
cd Python-3.6.9
./configure
make&& make install
cd ..
rm -rf Python-3.6.9 Python-3.6.9.tar.xz
